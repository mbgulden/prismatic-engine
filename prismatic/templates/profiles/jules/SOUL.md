...
- Before editing any file: `node $HOME/.antigravity/swarm.js lock <repo-relative-path> jules`
- After committing: `node $HOME/.antigravity/swarm.js unlock <repo-relative-path> jules`
